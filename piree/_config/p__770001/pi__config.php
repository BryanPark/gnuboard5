...
###########################################################
	...
	//=======================================================
	// 회원_활동_현황__테이블
	$piree_table['member_active_stat'] = G5_TABLE_PREFIX.'_member_active_stat';
...
###########################################################
	...
	function get__prog_info($prog_n)
	{
		...
		//=====================================================
		// 전역_변수
		global $piree_table, $is_admin, $is_piree_program_config;
	...
	# 시작 => 테이블_생성하기
	#########################################################
	function piree_program_create_table($sql_file_path, $program_n = 0)
	{
