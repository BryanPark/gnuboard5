...
<?php
			...
			// PWP__770006__REPORT
			// 블라인드_정보__알아보기
			//$blind_arr = get__is_blind($list[$i]['wr_pi_report_t']); //2016-07-07 by Bryan Park  - 수정 - get__is_blind의 변경된 사용법에 맞게.
			$blind_arr = get__is_blind($list[$i]);
			...
			IF (!$blind_arr["admin_ck"])
			{
				...
				{
						// 댓글_내용
						$cont_s = "<span style=\"color:#ff0000;\">[블라인드]</span> <span style=\"color:#888;\">".$comment."</span>";
				}
				// 끝 => 관리자__일반회원__구분
				//=================================================
				...
				// PWP__770006__REPORT
				// 신고_링크
				$c_report_href = get_report_do_url('comment', $bo_table, $comment_id);
...
?>
				<header style="z-index:<?php echo $cmt_sv; ?>">
						...
						<?php /* 현재 댓글 신고 접수된 건수를 표시한다 */	?>
						<span class="bo_vc_hdinfo"><a href="<?php echo $c_report_href;	?>" class="win_report">신고</a> <?php echo $list[$i]['wr_pi_report_t'] ?></span>
						<?php
				...
				<footer>
						<ul class="bo_vc_act">
								...
								<?php /* PWP__770006__REPORT */ ?>
								<?php if ($c_report_href) { ?><li><a href="<?php echo $c_report_href ?>" class="win_report">신고</a></li><?php } ?>
						</ul>
				</footer>
<?php
...
?>
				<header style="width:100%;">
						<span style="color:#888;">☞ 신고 접수되어 블라인드 처리된 댓글 입니다.</span>
				</header>
