...
ini_set("display_errors", 1);
	...
	//=======================================================
	// 피리_게시글에_투표__복수_질문__설정_정보__가져오기
	$is_get__article_vote = 1;


	//=======================================================
	// 피리_게시글에_투표__복수_질문__설정_정보_파일__경로
	//include_once( get__sam_file($piree_menu_n, '') );

	#########################################################
	# 끝 => 피리_게시글에_투표__복수_질문__설정_정보_파일__첨부
	#########################################################
...
<?php
			...
			//IF ( $ARTI_VOTE_prog_u && $ARTI_VOTE_prog_p && $board['bo_arti_vote_multi_use_n'] == 1 )
			//{

					//===============================================
					// PC__투표_입력창__열기
					//include_once( $ARTI_VOTE_SKIN_PC_p .'/vote_write_form.skin.php' );
					include_once(G5_SKIN_PATH.'/board/article_vote_practice/vote_write_form.skin.php');
