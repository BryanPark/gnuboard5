...
<?php
			...
			IF (!$blind_arr["admin_ck"])
			{
				...
				{
						// 댓글_내용
						$cont_s = "<span style=\"color:#ff0000;\">[블라인드]</span> <span style=\"color:#888;\">".$str."</span>";
				}
				// 끝 => 관리자__일반회원__구분
				//=================================================
...
<?php
				...
				// 시작 => 신고_건수__있으면
				/* PWP__770006__REPORT */
				/* 현재 댓글 신고 접수된 건수를 표시한다 */
				IF ($list[$i]['wr_pi_report_t'] > 0)
				{
?>
...
?>
				...
				<footer>
						<ul class="bo_vc_act">
								...
								<li><a href="<?php echo $c_report_href;	?>" class="win_report">신고</a></li>
						</ul>
				</footer>
				<?php } ?>
<?php
