...
===========================================================
	...
	작성날짜 : 2015년 01월 04일 일요일 오전 01시 06분, 날씨 추버 추버~~ 너무 추버~~
...
*/
	...
	//=======================================================
	// 피리_게시글에_투표__설정_정보_화일__경로
	include_once( get__sam_file($piree_menu_n, '') );

	#########################################################
	# 끝 => 피리_게시글에_투표__설정_정보_화일__첨부
	#########################################################
...
<?
										...
										//=====================================
										// 모바일__투표_입력창__열기
										include_once ( $ARTI_VOTE_SKIN_MO_p ."/vote_write_form.skin.php");
