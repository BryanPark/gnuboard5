...
*/
	define('ISPOP_CLASS_PATH',G5_PATH.'/adm/ispop_admin/classes');	

	
	// Eyoom DB Table
	$g5['ispop_respond']	= G5_TABLE_PREFIX.'ispop_respond';
	$g5['ispop_member']		= G5_TABLE_PREFIX.'ispop_member';
	$g5['ispop_new']		= G5_TABLE_PREFIX.'ispop_new';
	$g5['ispop_activity']	= G5_TABLE_PREFIX.'ispop_activity';
	$g5['ispop_guest']		= G5_TABLE_PREFIX.'ispop_guest';
	$g5['ispop_theme']		= G5_TABLE_PREFIX.'ispop_theme';
	$g5['ispop_board']		= G5_TABLE_PREFIX.'ispop_board';
	$g5['ispop_banner']		= G5_TABLE_PREFIX.'ispop_banner';
	$g5['ispop_menu']		= G5_TABLE_PREFIX.'ispop_menu';
	$g5['ispop_link']		= G5_TABLE_PREFIX.'ispop_link';
	$g5['ispop_attendance'] = G5_TABLE_PREFIX.'ispop_attendance'; 
	
	//include_once(ISPOP_CLASS_PATH.'/class.init.php');
	global $levelset,$ispoper;
	define ('ispop_config', G5_DATA_PATH."/ispop.config.php");
	if(@file_exists(ispop_config)){
		@include_once(ispop_config);
		
		$levelset_config_file = G5_DATA_PATH."/ispop.levelset.php";
		...
		$levelinfo_config_file = G5_DATA_PATH."/ispop.levelinfo.php";
