...
*/
	...
	function save_piree__program_info()
	{
	  	...
	  	//===================================================
	  	// 외부_상수__전역_변수
	  	global $piree, $g_program_n, $g_program_c, $g_program_s, $g_program_version_s, $is_paid, $prog_memo_s;
	  	...
	  	$sql_save .= "`pgs_prog_n`			= '". $g_program_n ."', ";
	  	...
	  	$sql   = "SELECT COUNT(*) FROM `".$piree['program_sam']."` WHERE `pgs_prog_n` = '". $g_program_n ."'";
	  	$exist = sql_efv($sql);
