...
// ISPOP -  Class Object Initialization
...
<form name="fmemberlevel" action="./member_level_update.php" method="post">
...
<?php echo $frm_submit; //submit button 출력.?>
		...
		<tr>
            ...
            <td>
				...
				<div>
					...
					<span class="bo_btns" style="display:inline-block;width:80px;text-align:center;"><a href="javascript:;" onclick="calc_ispop_level();return false;" style="background:#ff3061;color:#fff;padding:5px;border:0;">계산하기</a></span>  <span class="exp">계산하기를 실행한 후, [확인]버튼을 클릭해야만 정상적으로 적용이 됩니다.</span>
				</div>
			</td>
		</tr>
		<tr>
