...
$levelset_config = G5_DATA_PATH.'/ispop.levelset.php';
...
$qfile->save_file('levelset',$levelset_config,$levelset);//이걸 불러와야 저장을 한다.

$levelinfo_config = G5_DATA_PATH.'/ispop.levelinfo.php';
