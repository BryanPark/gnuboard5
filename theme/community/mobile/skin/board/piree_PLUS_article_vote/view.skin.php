...
===========================================================
	...
	프로젝트 이름 : 피리 웹프로그램 - 피리 게시글에 투표 PLUS G5

	만든사람 : 피리 PIREE

	홈페이지 : http://www.piree.co.kr

	작성날짜 : 2014년 12월 26일 금요일 오후 15시 39분 - 날씨 맑지만 쌀쌀하다
...
<article id="bo_v" style="width:<?php echo $width; ?>">
		<header>
				<h1 id="bo_v_title">
						...
						echo "태그 : ".cut_str(get_text($view['wr_subject']), 70); // 글제목 출력
						?>
				</h1>
		</header>
		...
		<section id="bo_v_info">
				<h2>페이지 정보</h2>
				작성자 : <?=level_icon($view['mb_id']);?><strong><?php echo $view['name'] ?><?php if ($is_ip_view) { echo "&nbsp;($ip)"; } ?></strong>
