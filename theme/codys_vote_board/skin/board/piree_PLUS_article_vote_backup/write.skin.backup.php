...
<?php
			...
			<div class="tbl_frm01 tbl_wrap">
					...
					<?php } ?>
					<?php //투표!!!!!
					include_once( $ARTI_VOTE_SKIN_PC_p .'/vote_write_form.skin.php');
					?>
					<?php if ($option) { ?>
					<tr>
							<th scope="row">옵션</th>
...
<?php
		...
		IF ($ARTI_VOTE_prog_u && $ARTI_VOTE_prog_p)
		{
				...
				### 2016-05-30 수정 내역 -> 무조건 투표에 체크 되있도록 설정, 그리고 투표 체크박스는 display:none;으로 style.css에서 처리.
?>
					<tr>
							<th scope="row"><label for="wr_use_arti_vote_n"><!--투표하기--><strong class="sound_only">선택</strong></label></th>
							<td>

									<div style="line_h_2_4">
											<input type="checkbox" name="wr_use_arti_vote_n" id="wr_use_arti_vote_n" value="1"<?php 	IF ($wr_use_arti_vote_n = 1) { echo " checked"; }	?>> 
											<!--"투표하기" 추가 합니다.-->
<?php
